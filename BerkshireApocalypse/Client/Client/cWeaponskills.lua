...
function Weaponskills.dxDraw()
	if(isWindowOpen())then
        ...
        dxDrawText(getWeaponNameFromID(getPedWeapon(localPlayer)).." Skill: "..math.floor(getElementData(localPlayer,Weaponskills.weapon)).."/1000", 1160*(x/1440), 242*(y/900), 1430*(x/1440), 284*(y/900), tocolor(255, 255, 255, 255), 1.00*(x/1440), NewFont, "center", "center", false, false, false, false, false)
	end
end
